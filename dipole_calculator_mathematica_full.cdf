...
NotebookDataLength[    176265,       4159]
NotebookOptionsPosition[    175810,       4123]
NotebookOutlinePosition[    176297,       4143]
CellTagsIndexPosition[    176254,       4140]
WindowFrame->Normal*)
...
linear system of equations of the type: \!\(\*SubscriptBox[\(E\), \(s/p\)]\)(\
\!\(\*SubscriptBox[\(k\), \(x\)]\),\!\(\*SubscriptBox[\(k\), \
\(y\)]\))=\!\(\*FractionBox[\(A + \[ImaginaryI]B\), \(\*SubscriptBox[\(k\), \
\(0\)] \*SubscriptBox[\(k\), \(z\)]\)]\), with A and B specified by the user. \
For the singular point \!\(\*SubscriptBox[\(k\), \(x\)]\)=\!\(\*SubscriptBox[\
\(k\), \(y\)]\)=0, where the polarisations are not well-defined, \
...
$CellContext`plus = "+"; $CellContext`with = "With"; $CellContext`compl = 
  ...
  ImageSizeCache->{281., {48., 55.}}]], "Output",
 Editable->False,
 CellOpen->False,
 FontSize->12],
...
Cell[BoxData[
 RowBox[{
  ...
  DynamicBox[ToBoxes[$CellContext`imA6 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`kx1 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`kx2 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`kx3 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`kx4 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`kx5 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`kx6 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`ky1 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`ky2 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`ky3 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`ky4 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`ky5 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
  DynamicBox[ToBoxes[$CellContext`ky6 = 0, StandardForm],
   ImageSizeCache->{7., {0., 8.}}], " ", 
...
\\!\\(\\*SubscriptBox[\\(E\\), \\(s/p\\)]\\)(\\!\\(\\*SubscriptBox[\\(k\\), \
\\(x\\)]\\),\\!\\(\\*SubscriptBox[\\(k\\), \\(y\\)]\\))=\\!\\(\\*FractionBox[\
\\(A + \[ImaginaryI]B\\), \\(\\*SubscriptBox[\\(k\\), \\(0\\)] \
\\*SubscriptBox[\\(k\\), \\(z\\)]\\)]\\), with A and B specified by the user. \
For the singular point \\!\\(\\*SubscriptBox[\\(k\\), \
\\(x\\)]\\)=\\!\\(\\*SubscriptBox[\\(k\\), \\(y\\)]\\)=0, where the \
polarisations are not well-defined, \\!\\(\\*SubscriptBox[\\(e\\), \
\\(s\\)]\\) and \\!\\(\\*SubscriptBox[\\(e\\), \\(p\\)]\\) are taken as \
\\!\\(\\*OverscriptBox[\\(x\\), \\(^\\)]\\) and \
\\!\\(\\*OverscriptBox[\\(y\\), \\(^\\)]\\), respectively.\"\>",
     StripOnInput->False,
     LineSpacing->{1.5, 0},
...
\\(k\\), \\(0\\)]\\))\"\>",
        ...
        FontWeight->Bold], "\[SpanFromLeft]", "\[SpanFromLeft]"},
      {
       ...
       StyleBox["\<\"1st point\"\>",
        StripOnInput->False,
        FontFamily->"Helvetica"], 
       InputFieldBox[Dynamic[$CellContext`kx1],
        FieldHint->"kx1/k0",
        FieldSize->Tiny], 
       InputFieldBox[Dynamic[$CellContext`ky1],
        FieldHint->"ky1/k0",
        FieldSize->Tiny], 
       InterpretationBox[
        StyleBox[
        ...
        FieldSize->Tiny]},
      {
       ...
       StyleBox["\<\"2nd point\"\>",
        StripOnInput->False,
        FontFamily->"Helvetica"], 
       InputFieldBox[Dynamic[$CellContext`kx2],
        FieldHint->"kx2/k0",
        FieldSize->Tiny], 
       InputFieldBox[Dynamic[$CellContext`ky2],
        FieldHint->"ky2/k0",
        FieldSize->Tiny], 
       InterpretationBox[
        StyleBox[
        ...
        FieldSize->Tiny]},
      {
       ...
       StyleBox["\<\"3rd point\"\>",
        StripOnInput->False,
        FontFamily->"Helvetica"], 
       InputFieldBox[Dynamic[$CellContext`kx3],
        FieldHint->"kx3/k0",
        FieldSize->Tiny], 
       InputFieldBox[Dynamic[$CellContext`ky3],
        FieldHint->"ky3/k0",
        FieldSize->Tiny], 
       InterpretationBox[
        StyleBox[
        ...
        FieldSize->Tiny]},
      {
       ...
       StyleBox["\<\"4th point\"\>",
        StripOnInput->False,
        FontFamily->"Helvetica"], 
       InputFieldBox[Dynamic[$CellContext`kx4],
        FieldHint->"kx4/k0",
        FieldSize->Tiny], 
       InputFieldBox[Dynamic[$CellContext`ky4],
        FieldHint->"ky4/k0",
        FieldSize->Tiny], 
       InterpretationBox[
        StyleBox[
        ...
        FieldSize->Tiny]},
      {
       ...
       StyleBox["\<\"5th point\"\>",
        StripOnInput->False,
        FontFamily->"Helvetica"], 
       InputFieldBox[Dynamic[$CellContext`kx5],
        FieldHint->"kx5/k0",
        FieldSize->Tiny], 
       InputFieldBox[Dynamic[$CellContext`ky5],
        FieldHint->"ky5/k0",
        FieldSize->Tiny], 
       InterpretationBox[
        StyleBox[
        ...
        FieldSize->Tiny]},
      {
       ...
       StyleBox["\<\"6th point\"\>",
        StripOnInput->False,
        FontFamily->"Helvetica"], 
       InputFieldBox[Dynamic[$CellContext`kx6],
        FieldHint->"kx6/k0",
        FieldSize->Tiny], 
       InputFieldBox[Dynamic[$CellContext`ky6],
        FieldHint->"ky6/k0",
        FieldSize->Tiny], 
       InterpretationBox[
        StyleBox[
...
Cell[BoxData[
 DynamicBox[ToBoxes[$CellContext`result, StandardForm],
  ImageSizeCache->{553., {61., 69.}}]], "Print"],
...
$CellContext`kx1], $CellContext`ky -> $CellContext`ky1]]], SaveDefinitions -> 
   ...
   StandardForm],
  ImageSizeCache->{524., {22., 29.}},
  Initialization:>{$CellContext`point1 = False, $CellContext`kx1 = 
    0, $CellContext`ky1 = 
    0, $CellContext`EsEpp = (((I/
...
$CellContext`kx2], $CellContext`ky -> $CellContext`ky2]]], SaveDefinitions -> 
   ...
   StandardForm],
  ImageSizeCache->{7., {0., 8.}},
  Initialization:>{$CellContext`point2 = True, $CellContext`kx2 = 
    0, $CellContext`ky2 = 0, $CellContext`pol2 = "spol", $CellContext`plane2 = 
...
$CellContext`kx3], $CellContext`ky -> $CellContext`ky3]]], SaveDefinitions -> 
   ...
   StandardForm],
  ImageSizeCache->{7., {0., 8.}},
  Initialization:>{$CellContext`point3 = True, $CellContext`kx3 = 
    0, $CellContext`ky3 = 0, $CellContext`pol3 = "spol", $CellContext`plane3 = 
    "zplus", $CellContext`EsEpp = ((I/
       8) $CellContext`k1^2 (-((($CellContext`kx $CellContext`kz1 \
$CellContext`mx)/($CellContext`k1 $CellContext`kt) + ($CellContext`ky \
$CellContext`kz1 $CellContext`my)/($CellContext`k1 $CellContext`kt) + \
...
$CellContext`kx4], $CellContext`ky -> $CellContext`ky4]]], SaveDefinitions -> 
   ...
   StandardForm],
  ImageSizeCache->{7., {0., 8.}},
  Initialization:>{$CellContext`point4 = True, $CellContext`kx4 = 
    0, $CellContext`ky4 = 0, $CellContext`pol4 = "spol", $CellContext`plane4 = 
    "zplus", $CellContext`EsEpp = ((I/
       8) $CellContext`k1^2 (-((($CellContext`kx $CellContext`kz1 \
$CellContext`mx)/($CellContext`k1 $CellContext`kt) + ($CellContext`ky \
$CellContext`kz1 $CellContext`my)/($CellContext`k1 $CellContext`kt) + \
...
$CellContext`kx5], $CellContext`ky -> $CellContext`ky5]]], SaveDefinitions -> 
   ...
   StandardForm],
  ImageSizeCache->{7., {0., 8.}},
  Initialization:>{$CellContext`point5 = True, $CellContext`kx5 = 
    0, $CellContext`ky5 = 0, $CellContext`pol5 = "spol", $CellContext`plane5 = 
    "zplus", $CellContext`EsEpp = ((I/
       8) (-((($CellContext`kx 
...
$CellContext`ky^2) $CellContext`pz)/
        Sqrt[$CellContext`kx^2 + $CellContext`ky^2]))/(
     Sqrt[1 - $CellContext`kx^2 - $CellContext`ky^2] Pi^2), $CellContext`A5 = 
    0}]], "Output",
 Editable->False,
 CellOpen->False,
 FontSize->12],
...
$CellContext`kx6], $CellContext`ky -> $CellContext`ky6]]], SaveDefinitions -> 
   ...
   StandardForm],
  ImageSizeCache->{7., {0., 8.}},
  Initialization:>{$CellContext`point6 = True, $CellContext`kx6 = 
    0, $CellContext`ky6 = 0, $CellContext`pol6 = "spol", $CellContext`plane6 = 
    "zplus", $CellContext`EsEpp = ((I/
       8) (-((($CellContext`kx 
            Sqrt[1 - $CellContext`kx^2 - $CellContext`ky^2] $CellContext`mx)/
           Sqrt[$CellContext`kx^2 + $CellContext`ky^2] + ($CellContext`ky 
...
$CellContext`M4, $CellContext`M5, $CellContext`M6}, {$CellContext`A1, \
$CellContext`A2, $CellContext`A3, $CellContext`A4, $CellContext`A5, \
$CellContext`A6}]], FontFamily -> "Helvetica", FontSize -> 14], 
       Style[
  ...
  ImageSizeCache->{553., {61., 69.}}]], "Output",
 Editable->False,
 CellOpen->False,
 FontSize->12]
}, Open  ]]
...
Notebook[{
Cell[CellGroupData[{
Cell[1486, 35, 96543, 2330, 19, "Input",
 CellOpen->False],
Cell[98032, 2367, 4176, 99, 19, "Output",
 CellOpen->False],
Cell[102211, 2468, 3235, 66, 19, "Output",
 CellOpen->False],
Cell[105449, 2536, 1222, 34, 19, "Output",
 CellOpen->False],
Cell[106674, 2572, 431, 12, 44, "Output"],
Cell[107108, 2586, 30899, 759, 342, "Output"],
Cell[138010, 3347, 118, 2, 140, "Print"],
Cell[138131, 3351, 1385, 30, 60, "Output"],
Cell[139519, 3383, 545, 12, 19, "Output",
 CellOpen->False],
Cell[140067, 3397, 5305, 104, 19, "Output",
 CellOpen->False],
Cell[145375, 3503, 5302, 104, 19, "Output",
 CellOpen->False],
Cell[150680, 3609, 5302, 104, 19, "Output",
 CellOpen->False],
Cell[155985, 3715, 5302, 104, 19, "Output",
 CellOpen->False],
Cell[161290, 3821, 6116, 121, 19, "Output",
 CellOpen->False],
Cell[167409, 3944, 6116, 121, 19, "Output",
 CellOpen->False],
Cell[173528, 4067, 310, 7, 19, "Output",
 CellOpen->False],
Cell[173841, 4076, 1953, 44, 19, "Output",
 CellOpen->False]
}, Open  ]]
}
]
...
(* NotebookSignature LvpEVFNcqtsS0BKAtC7drEyS *)

...
NotebookDataLength[    177309,       4184]
NotebookOptionsPosition[    176854,       4148]
NotebookOutlinePosition[    177341,       4168]
CellTagsIndexPosition[    177298,       4165]
WindowFrame->Normal*)
...
StyleBox[\"E\",
FontWeight->\"Bold\"]\)(\!\(\*SubscriptBox[\(k\), \
\(x\)]\),\!\(\*SubscriptBox[\(k\), \(y\)]\))=\!\(\*FractionBox[\(A + \
\[ImaginaryI]B\), \(\*SubscriptBox[\(k\), \(0\)] \*SubscriptBox[\(k\), \(z\)]\
\)]\), with A and B specified by the user. For the singular point \
\!\(\*SubscriptBox[\(k\), \(x\)]\)=\!\(\*SubscriptBox[\(k\), \(y\)]\)=0, \
where the polarisations are not well-defined, \!\(\*SubscriptBox[\(e\), \
...
\[NTilde]o, Engineering far and near-field directionality: full amplitude and \
phase control of guided mode excitation from a single dipole source, ArXiv \
xxxxx\>\"", ",", 
             RowBox[{"FontFamily", "\[Rule]", "\"\<Helvetica\>\""}], ",", 
             RowBox[{"FontSlant", "\[Rule]", "Italic"}], ",", "Gray"}], "]"}],
            ",", 
...
xxxxx\>\"", ",", 
         ...
         RowBox[{"NotebookLocate", "[", 
          RowBox[{"{", 
           RowBox[{
            RowBox[{
            "URL", "[", "\"\<https://arxiv.org/abs/1708.02494\>\"", "]"}], 
            ",", "None"}], "}"}], "]"}], ",", 
...
\\!\\(\\*SubscriptBox[\\(e\\), \\(s\\)]\\) and \\!\\(\\*SubscriptBox[\\(e\\), \
\\(p\\)]\\) are taken as \\!\\(\\*OverscriptBox[\\(x\\), \\(^\\)]\\) and \
...
Rodr\[IAcute]guez-Fortu\[NTilde]o, Engineering far and near-field \
directionality: full amplitude and phase control of guided mode excitation \
from a single dipole source, ArXiv xxxxx\"", FontFamily -> "Helvetica", 
          FontSlant -> Italic, 
...
from a single dipole source, ArXiv xxxxx\"", FontFamily -> "Helvetica", 
       ...
       0], ButtonFunction :> NotebookLocate[{
         URL["https://arxiv.org/abs/1708.02494"], None}], Appearance -> None, 
...
Notebook[{
Cell[CellGroupData[{
Cell[1486, 35, 96250, 2320, 19, "Input",
 CellOpen->False],
Cell[97739, 2357, 4178, 99, 19, "Output",
 CellOpen->False],
Cell[101920, 2458, 2035, 42, 19, "Output",
 CellOpen->False],
Cell[103958, 2502, 1221, 34, 19, "Output",
 CellOpen->False],
Cell[105182, 2538, 431, 12, 44, "Output"],
Cell[105616, 2552, 31217, 771, 348, "Output"],
Cell[136836, 3325, 118, 2, 160, "Print"],
Cell[136957, 3329, 1381, 30, 60, "Output"],
Cell[138341, 3361, 545, 12, 19, "Output",
 CellOpen->False],
Cell[138889, 3375, 5944, 117, 19, "Output",
 CellOpen->False],
Cell[144836, 3494, 5938, 117, 19, "Output",
 CellOpen->False],
Cell[150777, 3613, 5938, 117, 19, "Output",
 CellOpen->False],
Cell[156718, 3732, 5938, 117, 19, "Output",
 CellOpen->False],
Cell[162659, 3851, 5938, 117, 19, "Output",
 CellOpen->False],
Cell[168600, 3970, 5938, 117, 19, "Output",
 CellOpen->False],
Cell[174541, 4089, 298, 8, 19, "Output",
 CellOpen->False],
Cell[174842, 4099, 1996, 46, 19, "Output",
 CellOpen->False]
}, Open  ]]
}
]
...
(* NotebookSignature IxDowHPoymCjnCgZraTc3p@# *)
